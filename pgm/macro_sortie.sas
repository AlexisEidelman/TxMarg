...
%macro sortie_tx_marg;
	...
	data difference;
		...
		nb_menages = 1;
		label  nb_menages='Nombre de ménages concernés';
	run;
	...
	*	drop d_: ;
	...
	outfile="&chem_sortie\result_test"; sheet="net100";
	run;
	...
	* Sur le delta entre modele et modele0;
	...
	outfile="&chem_sortie\stat_desc"; sheet="d_X";
	run;
	...
	* Sur les augmentations relatives entre modele et modele0;
	...
	outfile="&chem_sortie\stat_desc"; sheet="r_X";
	run;
	...
	* Sur les taux calculés en fonction de revnet;
	...
	outfile="&chem_sortie\stat_desc"; sheet="t_X";
	run;
	...
	*		where &class.<500;
	...
	%decomp_taux(graph,G1,revnet_1000,(typfam='I0'),"&chem_sortie.\result_net.xls",'I0'); * personnes seules sans enfant;
	%decomp_taux(graph,G1,revnet_2000,(typfam='I1'!typfam='I2+'),"&chem_sortie.\result_net.xls",'I1 I2+'); * personnes seules avec enfants;
	%decomp_taux(graph,G1,revnet_2000,(typfam='C0'),"&chem_sortie.\result_net.xls",'C0'); * Couples sans enfant;
	%decomp_taux(graph,G1,revnet_2000,(typfam='C1'),"&chem_sortie.\result_net.xls",'C1'); * Couples avec 1 enfant;
	%decomp_taux(graph,G1,revnet_2000,(typfam='C2'!typfam='C3+'),"&chem_sortie.\result_net.xls",'C2 C3+'); * Couples avec 2 ou + enfants;
	...
	*Définition des agrégats;
	...
	%decomp_taux(graph,G1,revbrut_1000,(typfam='I0'),"&chem_sortie.\result_brut.xls",'I0'); * personnes seules sans enfant;
	%decomp_taux(graph,G1,revbrut_2000,(typfam='I1'!typfam='I2+'),"&chem_sortie.\result_brut.xls",'I1 I2+'); * personnes seules avec enfants;
	%decomp_taux(graph,G1,revbrut_2000,(typfam='C0'),"&chem_sortie.\result_brut.xls",'C0'); * Couples sans enfant;
	%decomp_taux(graph,G1,revbrut_2000,(typfam='C1'),"&chem_sortie.\result_brut.xls",'C1'); * Couples avec 1 enfant;
	%decomp_taux(graph,G1,revbrut_2000,(typfam='C2'!typfam='C3+'),"&chem_sortie.\result_brut.xls",'C2 C3+'); * Couples avec 2 ou + enfants;
	...
	*Définition des agrégats;
	...
	%decomp_taux(graph,G1,revsbrut_1000,(typfam='I0'),"&chem_sortie.\result_superbrut.xls",'I0'); * personnes seules sans enfant;
	%decomp_taux(graph,G1,revsbrut_2000,(typfam='I1'!typfam='I2+'),"&chem_sortie.\result_superbrut.xls",'I1 I2+'); * personnes seules avec enfants;
	%decomp_taux(graph,G1,revsbrut_2000,(typfam='C0'),"&chem_sortie.\result_superbrut.xls",'C0'); * Couples sans enfant;
	%decomp_taux(graph,G1,revsbrut_2000,(typfam='C1'),"&chem_sortie.\result_superbrut.xls",'C1'); * Couples avec 1 enfant;
	%decomp_taux(graph,G1,revsbrut_2000,(typfam='C2'!typfam='C3+'),"&chem_sortie.\result_superbrut.xls",'C2 C3+'); * Couples avec 2 ou + enfants;
